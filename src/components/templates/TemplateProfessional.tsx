...
export const TemplateProfessional = ({ cvData }: { cvData: CVData }) => {
  ...
  return (
    <Card className="overflow-hidden border border-border">
      <div className="bg-white" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
        <div className="p-8 bg-white border-b-2" style={{ borderColor: colors.accent }}>
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-3xl font-bold mb-2" style={{ color: colors.primary }}>
                {safeValue(cvData.firstName)} {safeValue(cvData.lastName)}
              </h1>
              <div className="flex flex-wrap gap-4 text-sm mt-2" style={{ color: colors.text }}>
                {cvData.email && (
        ...
        <div className="p-8">
          {cvData.about && (
            <div className="mb-8">
              <h2 className="text-sm uppercase tracking-widest font-bold mb-3" style={{ color: colors.primary }}>
          ...
          {cvData.experiences.length > 0 && (
            <div className="mb-8">
              <h2 className="text-sm uppercase tracking-widest font-bold mb-4" style={{ color: colors.primary }}>
